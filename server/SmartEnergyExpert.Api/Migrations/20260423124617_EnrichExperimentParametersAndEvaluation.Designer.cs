...
namespace SmartEnergyExpert.Api.Migrations
{
    ...
    [Migration("20260423124617_EnrichExperimentParametersAndEvaluation")]
    partial class EnrichExperimentParametersAndEvaluation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartEnergyExpert.Api.Entities.ExperimentParameter", b =>
                {
                    ...
                    b.ToTable("ExperimentParameters", t =>
                        {
                            t.HasCheckConstraint("CK_ExperimentParameters_Weight", "\"Weight\" IS NULL OR \"Weight\" > 0");
                        });
                });
